...
class TRN(fewshot_re.framework.FewShotREModel):
    ...
    def __init__(self, sentence_encoder, hidden_size=230, eps=0.1, temp=100.0, step=10, smp=1, ratio=1.0, wtp=1.0, wtn=1.0, wtb=1.0, metric='dot'):
        fewshot_re.framework.FewShotREModel.__init__(self, sentence_encoder)
    ...
    def forward(self, support, query, N, K, total_Q, templates):
        '''
        ...
        # templates_emb = self.sentence_encoder(templates)
